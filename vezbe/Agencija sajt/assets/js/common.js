			...
			$.ajax({
				...
				success: function (data) {
					...
					if (data) { //expect 1
						...
						showModal('<span class="theme-color">Vaša poruka je poslata. Potrudićemo se da Vam odgovorimo u najkraćem mogućem roku.</span>', '', false);
						setTimeout(function () {
							closeModal();
						}, 3000);
					} else {
						showModal('Nešto nije u redu :(<br>Molimo Vas pokupajte ponovo ili nas kontaktirajte putem telefona.', '', false);
					}
				},
				...
				case 'image':
					$(content)
						...
						.error(function () {
							//disable preloader
							closePreloader(200, function () {
								showModal('Nešto nije u redu..\nMolimo Vas pokušajte ponovo.', '', false);
							});
						});
					break
